...
export const ADD_COMMENT = "build-a-body/exercises/ADD_COMMENT";
...
export const ADD_LIKED_EXERCISE = "build-a-body/exercises/ADD_LIKED_EXERCISE";
export const REMOVE_LIKED_EXERCISE = "build-a-body/exercises/REMOVE_LIKED_EXERCISE";
...
export const addLikedExercise = (likedExercise) => ({ type: ADD_LIKED_EXERCISE, likedExercise });
export const removeLikedExercise = (likedExerciseId, userId) => ({ type: REMOVE_LIKED_EXERCISE, likedExerciseId, userId });
